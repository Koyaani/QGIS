...
class CORE_EXPORT QgsGeometryValidator : public QThread
{
  ...
  private:
    ...
    static double distLine2Point( double px, double py, QgsVector v, double qX, double qY );
    static bool intersectLines( double px, double py, QgsVector v, double qx, double qy, QgsVector w, double &sX, double &sY );
