...
class CORE_EXPORT QgsHillshadeRenderer : public QgsRasterRenderer
{
  ...
  private:
    ...
    static double calcFirstDerX( double x11, double x21, double x31, double x12, double x22, double x32, double x13, double x23, double x33, double cellsize );

    //! Calculates the first order derivative in y-direction according to Horn (1981)
    static double calcFirstDerY( double x11, double x21, double x31, double x12, double x22, double x32, double x13, double x23, double x33, double cellsize );
};
