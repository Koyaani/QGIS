...
class QgsGeoreferencerMainWindow : public QMainWindow, private Ui::QgsGeorefPluginGuiBase
{
  ...
  private:
    ...
    */
    ...
    static QgsRectangle transformViewportBoundingBox( const QgsRectangle &canvasExtent, QgsGeorefTransform &t,
    ...
    static QString guessWorldFileName( const QString &rasterFileName );
    bool checkFileExisting( const QString &fileName, const QString &title, const QString &question );
    static bool equalGCPlists( const QgsGCPList &list1, const QgsGCPList &list2 );
