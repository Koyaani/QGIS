...
class GUI_EXPORT QgsAttributesDnDTree : public QTreeWidget
{
  ...
  public:
     ...
     */
    static QTreeWidgetItem *addItem( QTreeWidgetItem *parent, QgsAttributesFormProperties::DnDTreeItemData data, int index = -1, const QIcon &icon = QIcon() );
    static QTreeWidgetItem *addContainer( QTreeWidgetItem *parent, const QString &title, int columnCount );
